...
# Set your API key
os.environ["GOOGLE_API_KEY"] = "AIzaSyBsa_A-EdCBWIFljT_PpnxRmQ9FffB74Fc"
...
def extract_text_from_file(file_path):
    ...
    try:
        if ext == 'pdf':
            ...
            print("Extracted text from PDF:", text[:500])  # Print first 500 characters for debugging
            return text
        elif ext == 'docx':
            ...
            with open(file_path, 'r') as file:
                text = file.read()
            print("Extracted text from TXT:", text[:500])
            return text
...
def question_mcqs_generator(input_text, num_questions):
    ...
    try:
        ...
        print("Generated MCQs:", mcqs[:500])  # Print first 500 characters for debugging
        return mcqs
    except Exception as e:
...
def save_mcqs_to_file(mcqs, filename):
    ...
    try:
        ...
        print(f"Error saving MCQs to {filename}: {e}")
        return None
...
def generate_mcqs():
    ...
    if file and allowed_file(file.filename):
        ...
        if text and text.strip():
            ...
            if "Error" in mcqs:
                return mcqs  # Show error message to the user if generation fails
            ...
            return "The extracted text is empty or too short for generating questions."
